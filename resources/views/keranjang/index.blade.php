                                ...
                                @foreach($keranjangs as $item)
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <form action="{{ route('keranjang.update', $item->menu_id) }}" method="POST" class="d-flex">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('keranjang.destroy', $item->menu_id) }}" method="POST" 
                ...
                <div class="card sticky-top" style="top: 100px;">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span>{{ $keranjangs->sum('qty') }} porsi</span>
                        </div>
                        <hr>
